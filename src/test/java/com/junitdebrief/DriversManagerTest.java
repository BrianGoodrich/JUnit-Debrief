...
public class DriversManagerTest {
    ...
    public void setup(){
        ...
        driversManager.addDriver( new Drivers( "Emilio", "1234990", 10f ) );
        driversManager.addDriver( new Drivers( "Pedro", "12312440", 12f ) );
        driversManager.addDriver( new Drivers( "Constanza", "9824990", 11f ) );
...
//Part 1
    ...
    public void startTripTest(){
        Drivers driver = driversManager.getDriver("1234990"); //Get Emilio Drivers object from hash map by key
    ...
    public void endTripTest(){
        Drivers driver = driversManager.getDriver("12312440"); //Get Pedro Drivers object from hash map by key
